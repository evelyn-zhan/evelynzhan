    ...
    return (
        <header className="px-16 py-10">
            <nav className="flex flex-row justify-end items-center gap-x-10 text-xl font-medium">
                <Link to="/" className={`${currentPath.pathname === "/" ? (darkMode ? 'text-primary' : 'text-darker') : ''} hover:font-bold hover:underline transition-all ease-in-out duration-600`}>About</Link>
                <Link to="/project" className={`${currentPath.pathname === "/project" ? 'text-primary' : ''} hover:font-bold hover:underline transition-all ease-in-out duration-600`}>Projects</Link>
                <Link to="/contact" className={`${currentPath.pathname === "/contact" ? 'text-primary' : ''} hover:font-bold hover:underline transition-all ease-in-out duration-600`}>Contact</Link>
                {
                    darkMode === false
